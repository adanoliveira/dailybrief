...
export function WorldNewsFeed({ topicSlug, searchQuery }: WorldNewsFeedProps) {
  ...
  const loadArticles = useCallback(async (pageNum: number, reset: boolean = false) => {
    ...
    try {
      ...
      const data = await getWorldFeed(params)
      ...
      console.error("Error fetching world articles:", err)
  ...
  useEffect(() => {
    ...
    loadArticles(1, true)
  }, [topicSlug, searchQuery, loadArticles])
  ...
  const renderEmptyState = () => (
    <Card className="bg-primary/5 border-primary/20 text-center">
      <CardContent className="pt-6 pb-4">
        ...
        <h3 className="text-lg font-medium mb-2">No headlines found</h3>
        <p className="text-muted-foreground">
          {searchQuery 
            ? "No headlines match your search criteria. Try a different search term."
            : topicSlug !== 'all' 
              ? "No headlines found in this topic. Try a different topic or check back later."
  ...
  const renderErrorState = () => (
    <Card className="bg-destructive/5 border-destructive/20 text-center">
      <CardContent className="pt-6 pb-4">
        ...
        <h3 className="text-lg font-medium mb-2">Failed to load headlines</h3>
